...
const Profile = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="bg-white/80 backdrop-blur-lg rounded-xl p-4 md:p-6 border border-blue-100 shadow-lg relative overflow-hidden"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center">
          <motion.div className="relative" whileHover={{ scale: 1.05 }}>
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden ring-4 ring-blue-100 shadow-inner bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-3xl md:text-5xl font-bold">
              {userData.username?.charAt(0)?.toUpperCase()}
            </div>
          </motion.div>

          <div className="text-center md:text-left flex-1">
            <h2 className="text-lg md:text-2xl font-semibold text-blue-900">
              {userData.username}
            </h2>
            ...
            <div className="mt-4 flex flex-wrap justify-center md:justify-start gap-3">
              <motion.button
                ...
                className="flex items-center gap-1 text-blue-600 hover:text-blue-800 bg-blue-50 px-3 py-1.5 rounded-lg hover:bg-blue-100 text-sm"
      ...
      <motion.div
        className="bg-white/80 backdrop-blur-lg rounded-xl p-4 md:p-6 border border-indigo-100 shadow-lg relative overflow-hidden"
        variants={itemVariants}
      >
        {/* Decorative corner elements */}
        ...
        <h2 className="text-lg font-semibold text-indigo-800 mb-4 flex items-center gap-2">
          <div className="p-2 bg-indigo-100 rounded-lg">
            <User className="text-indigo-600 w-4 h-4 md:w-5 md:h-5" />
          </div>
        ...
        <div className="space-y-4">
          <motion.div
            className="flex flex-col md:flex-row md:items-center gap-3 p-3 border-b border-indigo-100 hover:bg-indigo-50 rounded-lg transition-colors"
            whileHover={{ x: 3 }}
          >
            <div className="p-2 bg-indigo-100 rounded-full md:hidden">
              <Mail className="text-indigo-600 w-4 h-4" />
            </div>
            <div className="flex-1">
              <p className="text-sm text-indigo-500">Email</p>
              <p className="font-medium text-indigo-900 break-all">
                {userData.email}
              </p>
            </div>
            <motion.button
              onClick={() => openModal("email")}
              className="text-indigo-600 hover:text-indigo-800 bg-indigo-50 p-2 rounded-lg hover:bg-indigo-100 self-end md:self-auto"
