  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-1/4 right-10 w-60 h-60 bg-purple-500 opacity-5 rounded-full hidden md:block" />
        <div className="absolute bottom-20 left-1/4 w-40 h-40 bg-indigo-400 opacity-10 rounded-full hidden md:block" />
      </div>
      {/* Desktop Sidebar */}
      ...
      <div className="flex-1 flex flex-col h-screen overflow-auto">
        {/* Mobile Header */}
        <div className="md:hidden sticky top-0 px-4 py-3 flex items-center justify-between border-b border-blue-100 bg-white/80 backdrop-blur-lg shadow-sm z-20">
          <div>
